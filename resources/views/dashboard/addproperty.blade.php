<div class="dashboard__main pl0-md">
    <div class="dashboard__content property-page bgc-f7">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="ps-widget bgc-white bdrs12 default-box-shadow2 pt30 mb-6 overflow-hidden position-relative">
                                ...
                                <div class="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
                                    ...
                                    <form class="form-style1">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb20">
                                                    <label class="heading-color ff-heading font-weight-600 mb10">Title</label>
                                                        <input  type="text" class="form-control-ap" placeholder="Your Name">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="mb20">
                                                    <label  class="heading-color ff-heading font-weight-600 mb10">Description</label>
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20">
                                                    ...
                                                    <label class="heading-color ff-heading font-weight-600 mb10">Select Category</label>
                                                    <div class="location-area">
                                                        ...
                                                        <div >
                                                            <select id="select1" name="select1" class="form-select " style="width: 100%; height: 55px;" multiple>
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20">
                                                    ...
                                                    <label class="heading-color ff-heading font-weight-600 mb10">Listed in</label>
                                                    <div class="location-area">
                                                    ...
                                                    <select  id="select2" name="select2" class="form-select  " style="width: 100%; height: 55px;" multiple >
                                                            <optgroup label="Alaskan/Hawaiian Time Zone">
                                                                <option value="AK">Alaska</option>
                                                                <option value="HI">Hawaii</option>
                                                            </optgroup>
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20">
                                                    <label class="heading-color ff-heading font-weight-600 mb10">Property Status</label>
                                            <div class="location-area">
                                                        ...
                                                        <select  id="select3" name="select3" class="form-select  " style="width: 100%; height: 55px;"
                                                         multiple >
                                                            <optgroup label="Alaskan/Hawaiian Time Zone">
                                                                <option value="AK">Alaska</option>
                                                                <option value="HI">Hawaii</option>
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb-6">
                                                    <label class="heading-color ff-heading font-weight-600 mb10">Price in $</label>
                                                    <input type="text" class="form-control-ap" placeholder="Your Name">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb-6">
                                                    <label class="heading-color ff-heading font-weight-600 mb10">Yearly Tax Rate</label>
                                                    <input type="text" class="form-control-ap" placeholder="Your Name">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb-6">
                                                    <label class="heading-color ff-heading font-weight-600 mb10">After Price Label</label>
                                                    <input type="text"class="form-control-ap" placeholder="Your Name">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
                                    ...
                                    <form class="form-style1">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="upload-img position-relative overflow-hidden bdrs12 text-center mb-6 px-2">
                                                    ...
                                                    <h4 class="title fs-17 mb10">Upload/Drag photos of your property</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb-6">
                                                    <label class="heading-color ff-heading font-weight-600 mb10">Video from</label>
                                                    <div class="location-area">
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb-6">
                                                    <label class="heading-color ff-heading font-weight-600 mb10">Embed Video id</label><input type="text" class="form-control-ap" placeholder="Your Name">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xl-12">
                                                <div class="mb-6">
                                                    <label class="heading-color ff-heading font-weight-600 mb10">Virtual Tour</label>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Address</label><input
                                                        type="text" class="form-control-ap"
                                                        placeholder="Your Name"></div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20">
                                                    <label class="heading-color ff-heading font-weight-600 mb10">Country / State</label>
                                                    <div class="location-area">
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">City</label>
                                                    <div class="location-area">
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Country</label>
                                                    <div class="location-area ">
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Zip</label><input
                                                        type="text" class="form-control-ap"></div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Neighborhood</label><input
                                                        type="text" class="form-control-ap"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb-6"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Latitude</label><input
                                                        type="text" class="form-control-ap"></div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb-6"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Longitude</label><input
                                                        type="text" class="form-control-ap"></div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div
                                    ...
                                    <form class="form-style1">
                                        <div class="row">
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Size in
                                                        ft
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Lot
                                                        size in ft
                                                        (only numbers)</label><input type="text"
                                                        class="form-control-ap" placeholder="Your Name">
                                                </div>
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Rooms</label><input
                                                        type="text" class="form-control-ap"
                                                        placeholder="Your Name"></div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Bedrooms</label><input
                                                        type="text" class="form-control-ap"
                                                        placeholder="Your Name"></div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Bathrooms</label><input
                                                        type="text" class="form-control-ap"
                                                        placeholder="Your Name"></div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Custom
                                                        ID
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Garages</label><input
                                                        type="text" class="form-control-ap"
                                                        placeholder="Your Name"></div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Garage
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Year
                                                        built
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Available
                                                        from
                                                        (date)</label><input type="text"
                                                        class="form-control-ap" placeholder="99.aa.yyyy">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Basement</label><input
                                                        type="text" class="form-control-ap"
                                                        placeholder="Your Name"></div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Extra
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Roofing</label><input
                                                        type="text" class="form-control-ap"
                                                        placeholder="Your Name"></div>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Exterior
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Floors
                                                        no</label>
                                                    <div class="location-area">
                                                        ...
                                                        <select  id="select9" name="select9" class="form-select  " style="width: 100%; height: 55px;"" multiple >
                                                            <optgroup label="Alaskan/Hawaiian Time Zone">
                                                                <option value="AK">Alaska</option>
                                                                <option value="HI">Hawaii</option>
                                                            </optgroup>
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Structure
                                                        type</label>
                                                    <div class="location-area">
                                                        <select  id="select8" name="select8" class="form-select  " style="width: 100%; height: 55px;" multiple >
                                                            <optgroup label="Alaskan/Hawaiian Time Zone">
                                                                <option value="AK">Alaska</option>
                                                                <option value="HI">Hawaii</option>
                                                            </optgroup>
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Energy
                                                        Class</label>
                                                    <div class="location-area">
                                                        ...
                                                        <select  id="select10" name="select10" class="form-select  " style="width: 100%; height: 55px;" multiple >
                                                            <optgroup label="Alaskan/Hawaiian Time Zone">
                                                                <option value="AK">Alaska</option>
                                                                <option value="HI">Hawaii</option>
                                                            </optgroup>
                                            ...
                                            <div class="col-sm-6 col-xl-4">
                                                <div class="mb20"><label
                                                    ...
                                                    <div class="location-area">
                                                        ...
                                                        <select  id="select11" name="select11" class="form-select  " style="width: 100%; height: 55px;" multiple >
                                                            <optgroup label="Alaskan/Hawaiian Time Zone">
                                                                <option value="AK">Alaska</option>
                                                                <option value="HI">Hawaii</option>
                                                            </optgroup>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="mb20"><label
                                                        class="heading-color ff-heading font-weight-600 mb10">Owner/
                                                        Agent
